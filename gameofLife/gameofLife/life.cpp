...

{
    ...
    //Write code similar to dungeon wall checker if at top/bottom or corners the loop should skip that check
    if (row == 1 || row == maxrow || col == 1 || col == maxcol)
    {
        rowColCheck++;
        //cout << "Saved repitions = " << x << endl;
    }
    else
    {
       // neighborLoopCounter = 0;
    ...
    //cout << "Neighbor ran a total of " << neighbor << " times" << endl;
    //cout << "Y loop ran " << y << " times" << endl;
    return count;
}
